export class NetworkTimeBoundary{constructor(minimum,maximum){this.minimum=minimum;this.maximum=maximum;}
equals(other){return(this.minimum===other.minimum)&&(this.maximum===other.maximum);}}
export class NetworkTimeCalculator extends Common.Object{constructor(startAtZero){super();this.startAtZero=startAtZero;this._minimumBoundary=-1;this._maximumBoundary=-1;this._boundryChangedEventThrottler=new Common.Throttler(0);this._window=null;}
...
export const _minimumSpread=0.1;export const Events={BoundariesChanged:Symbol('BoundariesChanged')};export const _latencyDownloadTotalFormat=new Common.UIStringFormat('%s latency, %s download (%s total)');export const _latencyFormat=new Common.UIStringFormat('%s latency');export const _downloadFormat=new Common.UIStringFormat('%s download');export const _fromServiceWorkerFormat=new Common.UIStringFormat('%s (from ServiceWorker)');export const _fromCacheFormat=new Common.UIStringFormat('%s (from cache)');export class NetworkTransferTimeCalculator extends NetworkTimeCalculator{constructor(){super(false);}
...
self.Network=self.Network||{};Network=Network||{};Network.NetworkTimeBoundary=NetworkTimeBoundary;Network.NetworkTimeCalculator=NetworkTimeCalculator;Network.NetworkTimeCalculator._minimumSpread=_minimumSpread;Network.NetworkTimeCalculator.Events=Events;Network.NetworkTimeCalculator._latencyDownloadTotalFormat=_latencyDownloadTotalFormat;Network.NetworkTimeCalculator._latencyFormat=_latencyFormat;Network.NetworkTimeCalculator._downloadFormat=_downloadFormat;Network.NetworkTimeCalculator._fromServiceWorkerFormat=_fromServiceWorkerFormat;Network.NetworkTimeCalculator._fromCacheFormat=_fromCacheFormat;Network.NetworkTransferTimeCalculator=NetworkTransferTimeCalculator;Network.NetworkTransferDurationCalculator=NetworkTransferDurationCalculator;