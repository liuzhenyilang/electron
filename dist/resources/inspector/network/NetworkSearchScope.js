export default class NetworkSearchScope{performIndexing(progress){setImmediate(progress.done.bind(progress));}
...
self.Network=self.Network||{};Network=Network||{};Network.NetworkSearchScope=NetworkSearchScope;Network.UIRequestLocation=UIRequestLocation;Network.NetworkSearchResult=NetworkSearchResult;